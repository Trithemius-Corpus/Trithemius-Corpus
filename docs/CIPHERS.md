...
For the published *translations* of these works, the cryptographic substitutions are still **passed through as written** — the cipher streams in the body text are transcribed, not decoded inline. The decoding lives in the [cipher solutions page](cipher-solutions.html) and the cryptanalysis scripts. For the comprehensive modern English edition of the *Steganographia* and its angelological framing, see Skinner & Clark (2024); for the foundational cryptanalysis, Ernst (1996) and Reeds (1998), who independently solved Book III.

## Explore the cipher materials in this corpus

- [**Solved ciphers** — the *Clavis Steganographiae* decoded](cipher-solutions.html) — eleven worked examples spanning the simple *modi* (II–XI) and the high *modi* (XXXII–XXXIX), each cipher stream char-aligned to its recovered German plaintext beside the facsimile crop, with honest match percentages and scope.
